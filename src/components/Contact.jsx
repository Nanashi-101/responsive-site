      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 gap-10 items-center">
        <div className="contact-info flex flex-col">
          ...
          <div className="address-section my-6">
            ...
            <p className="flex gap-2 text-gray-300">
              <BiLogoGmail color="#ffbb00" size={20} /> -
              example.krypto@gmail.com
            </p>
            <p className="flex gap-2 text-gray-300">
              <BiSolidMap color="#ffbb00" size={20} /> - 32 street, North
              Carolina
            </p>
          </div>
        ...
        <div className="contact-form flex flex-col gap-4">
          <input
            className="text-white font-medium px-4 py-2 rounded-md bg-transparent border border-[#ffbb00]"
            type="text"
          ...
          />
          <button className=" w-[180px] md:text-sm sm:text-md text-lg my-2 mx-auto sm:ml-0  border border-[#ffbb00] bg-[#ffbb00] py-3 text-center font-bold rounded-md transition-all hover:tracking-wider" onClick={sendEmail}>
            Send message
          </button>
        </div>
      </div>
