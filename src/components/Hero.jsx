  ...
  return (
    ...
    >
      <div className='max-w-[800px] mx-auto h-screen flex flex-col text-center justify-center items-center'>
        <p className="uppercase md:text-3xl sm:text-2xl text-md font-medium p-2">Modified:See your money grow!</p>
        ...
        <div className="flex items-center flex-wrap justify-center">
            ...
            <ReactTyped 
            className="md:text-4xl sm:text-3xl text-lg font-medium p-2 text-[#ffbb00]"
