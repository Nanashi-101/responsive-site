...
const Hero = () => {
  return (
    <div className='text-white'>
      <div className='max-w-[800px] mt-[-96px] mx-auto h-screen flex flex-col text-center justify-center items-center'>
        ...
        <div className="flex items-center">
            ...
            <ReactTyped 
            className="md:text-4xl sm:text-3xl text-xl font-medium p-2 text-[#ffbb00]"
            strings={["Bitcoin", "Ethereum", "Tether", "USDT"]} 
            typeSpeed={100} 
            backSpeed={120} 
            loop/>
        </div>
        <div className="ctc-icons flex gap-1 mx-auto  text-[#ffbb00] mt-2 items-center">
            <FaBitcoin size={40}/>
            <FaEthereum size={40}/>
